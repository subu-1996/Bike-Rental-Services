...
class BikeRental:
    ...
    def rentBikeOnHourlyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged Rs.25 for each hour per bike.")
    ...
    def rentBikeOnWeeklyBasis(self, n):
        ...
        if n <= 0:
            ...
            print("You will be charged Rs.60 for each week per bike.")
            print("We hope that you enjoy our service.")
            self.stock -= n
    ...
    def returnBike(self, request):
        ...
        if rentalTime and rentalBasis and numOfBikes:
            ...
            if rentalBasis == 1:
                bill = round(rentalPeriod.seconds / 3600) * 25 * numOfBikes
